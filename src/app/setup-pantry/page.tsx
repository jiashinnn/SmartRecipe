...
export default function SetupPantryPage() {
      ...
      <form onSubmit={handleSubmit} className="px-4">
        <div className="space-y-4 mb-6">
          {items.map((item, index) => (
            ...
            >
              {/* Dynamic row layouts (stacks on mobile, parallel on desktop) */}
              <div className="flex flex-col gap-4 md:flex-row md:items-end">
                ...
                {/* Grid for Quantity and Unit to stay side-by-side on mobile for neat spacing */}
                ...
                {/* Delete button (stands out and stacks on mobile, aligns right on desktop) */}
                {items.length > 1 && (
                  <button
                    type="button"
